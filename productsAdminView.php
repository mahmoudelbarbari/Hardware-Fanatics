...
if ($is_db_connected == true) {
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo '</select><br />';
            echo "<a href='updateProduct.php?id=$id' data-id='$id' class='BtnAdditem'>Update Item</a>";
            echo "<a href='deleteProduct.php?id=$id' data-id='$id' class='BtnAdditem'>Delete Item</a>";
            echo '</div>';
            echo '</div>';
        }
        echo '</div>';
